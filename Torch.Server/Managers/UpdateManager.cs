...
namespace Torch.Managers
{
    ...
    public class UpdateManager : Manager
    {
        ...
        public UpdateManager(ITorchBase torchInstance)
            : base(torchInstance)
        {
        ...
        public async void CheckAndUpdateTorch()
        {
            ...
            if (Torch.Config.NoUpdate
                || !Torch.Config.GetTorchUpdates
                || (Torch.Config.BranchName == TorchBranchType.dev)
                || Torch.TorchVersion.Version == new Version(0, 0, 0))
                return;
